...
const I18N = {
  ja:{
    ...
    'undo-rename':'↩ 名前の変更を戻しました（Y で進む）','redo-rename':'↪ 名前の変更を進めました',
  ...
  'em-zip-lite':'📦 軽量保存（3DGS本体を除外）',
  'em-zip-lite-d':'カメラ・注釈・レイアウトのみ保存（高速・低容量）。読込時に元の3DGSファイルの選択が必要です',
  ...
  en:{
    ...
    'undo-rename':'↩ Undid rename (Y to redo)','redo-rename':'↪ Redid rename',
  ...
  'em-zip-lite':'📦 Lite Save (excludes 3DGS data)',
  'em-zip-lite-d':'Saves camera / annotations / layout only (fast, small). Loading it later asks you to re-select the original 3DGS file.',
